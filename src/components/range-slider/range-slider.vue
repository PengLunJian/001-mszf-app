    ...
    <view class="range-slider" :style="'width:' + width + 'rpx;height:' + height + 'rpx'">
        <view class="range-bar" :style="'width:100%;height:' + barHeight + 'rpx'">
            ...
            <view class="range-bar-progress"
                  :style="'margin-left:' + progressBarLeft + 'rpx;width:' + progressBarWidth + 'rpx;background:' + activeColor + ''"></view>
        </view>
...
<script>
    ...
    export default {
        ...
        props: {
            ...
            activeColor: {
                type: String,
                default: '-webkit-linear-gradient(left, #FFCC00, #FF9900)'
            },
            //最小值
            min: {
                type: Number,
